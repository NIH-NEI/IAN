...
source("IAN/R/gene_id_mapper_2.R")
source("IAN/R/enrichment_analysis_6.R")
source("IAN/R/multi_agent_system_5.R")
source("IAN/R/llm_prompts_5.R")
source("IAN/R/create_combined_prompt_3.R") # Source the new file
source("IAN/R/pathway_comparison_1.R") # Source the pathway comparison script
source("IAN/R/network_prompt_generator.R") # Source the combined network prompt generator script
source("IAN/R/system_model_prompt_generator.R") # Source the system model prompt generator script
source("IAN/R/visualize_system_model.R") # To visualize system model
...
input_type <- "deseq" # one of findmarker, deseq, custom
...
if (is.null(gene_mapping) || (is.list(gene_mapping) && "error" %in% names(gene_mapping))) {
  ...
  gene_symbols <- gene_mapping$SYMBOL
